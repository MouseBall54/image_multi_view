            ...
            {(appMode === 'compare' || appMode === 'pinpoint' || appMode === 'toggle' || appMode === 'analysis') && (
              <label><span>Layout:</span>
                <select value={`${viewerRows}x${viewerCols}`} onChange={e => {
                  ...
                  <option value="1x2">1×2 (2개)</option>
                  <option value="1x3">1×3 (3개)</option>
                  <option value="1x4">1×4 (4개)</option>
                  <option value="1x5">1×5 (5개)</option>
                  <option value="1x6">1×6 (6개)</option>
                  <option value="1x7">1×7 (7개)</option>
                  <option value="1x8">1×8 (8개)</option>
                  <option value="1x9">1×9 (9개)</option>
                  <option value="1x10">1×10 (10개)</option>
                  <option value="1x12">1×12 (12개)</option>
                  <option value="1x15">1×15 (15개)</option>
                  <option value="1x18">1×18 (18개)</option>
                  <option value="1x20">1×20 (20개)</option>
                  <option value="2x2">2×2 (4개)</option>
                  <option value="2x3">2×3 (6개)</option>
                  <option value="2x4">2×4 (8개)</option>
                  <option value="2x5">2×5 (10개)</option>
                  <option value="2x6">2×6 (12개)</option>
                  <option value="2x8">2×8 (16개)</option>
                  <option value="2x9">2×9 (18개)</option>
                  <option value="2x10">2×10 (20개)</option>
                  <option value="3x2">3×2 (6개)</option>
                  <option value="3x3">3×3 (9개)</option>
                  <option value="3x4">3×4 (12개)</option>
                  <option value="3x5">3×5 (15개)</option>
                  <option value="3x6">3×6 (18개)</option>
                  <option value="4x2">4×2 (8개)</option>
                  <option value="4x3">4×3 (12개)</option>
                  <option value="4x4">4×4 (16개)</option>
                  <option value="4x5">4×5 (20개)</option>
                  <option value="5x2">5×2 (10개)</option>
                  <option value="5x3">5×3 (15개)</option>
                  <option value="5x4">5×4 (20개)</option>
                  <option value="6x3">6×3 (18개)</option>
                  <option value="6x4">6×4 (24개)</option>
                  <option value="8x3">8×3 (24개)</option>
                  <option value="10x2">10×2 (20개)</option>
                </select>
              </label>
            )}
            {appMode === 'pinpoint' && (
