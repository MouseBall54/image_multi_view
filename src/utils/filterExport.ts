...
const FILTER_PARAMETER_MAP: Partial<Record<FilterType, string[]>> = {
  ...
  'threshold_binary': ['threshold', 'maxValue', 'binaryInvert'],
  'threshold_otsu': ['maxValue', 'binaryInvert'],
  'threshold_triangle': ['maxValue', 'binaryInvert'],
  'threshold_adaptive_mean': ['blockSize', 'constant', 'maxValue', 'binaryInvert'],
  'threshold_adaptive_gaussian': ['blockSize', 'constant', 'maxValue', 'binaryInvert'],
  'threshold_sauvola': ['windowSize', 'sauvolaK', 'sauvolaR', 'binaryInvert'],
  'threshold_bradley': ['windowSize', 'bradleyT', 'binaryInvert'],
  'threshold_bernsen': ['windowSize', 'bernsenContrast', 'binaryInvert'],
  'threshold_phansalkar': ['windowSize', 'phansalkarK', 'phansalkarR', 'phansalkarP', 'phansalkarQ', 'binaryInvert'],
  'threshold_kittler': ['binaryInvert'],
  ...
  'boxblur': ['kernelSize'],
  'boxblur_xy': ['kernelSizeX', 'kernelSizeY'],
  'gaussianblur': ['kernelSize', 'sigma'],
  'gaussianblur_xy': ['kernelSizeX', 'kernelSizeY', 'sigmaX', 'sigmaY'],
  'median': ['kernelSize'],
