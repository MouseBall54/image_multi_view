...
export const ViewToggleControls: React.FC<ViewToggleControlsProps> = ({ 
  ...
  const { showFilelist, setShowFilelist, showFilterLabels, setShowFilterLabels } = useStore();
      ...
      >
        <div className="toggle-icon">
          {showFilterLabels ? (
            ...
            // Filter labels hidden icon
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>
              <rect width="8" height="4" x="8" y="2" rx="1" ry="1"/>
              <path d="M12 11h4" opacity="0.3"/>
              <path d="M12 16h4" opacity="0.3"/>
            </svg>
          )}
        </div>
        <span className="toggle-label">
          {showFilterLabels ? 'Labels' : 'Labels'}
        </span>
      </button>
