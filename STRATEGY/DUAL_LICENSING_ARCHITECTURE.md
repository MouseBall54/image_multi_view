# Comparix 듀얼 라이센싱 아키텍처 설계서

## 📋 개요

Comparix의 상업화를 위한 **듀얼 라이센싱 모델** 구현 설계서입니다. Community Edition(MIT)과 Enterprise Edition(Commercial) 두 버전으로 분리하여 오픈소스 커뮤니티를 유지하면서 상업적 수익을 창출하는 구조를 제시합니다.
...
```json
{
  ...
  "dependencies": {
    "@Comparix/shared": "workspace:*",
    "react": "^18.2.0",
    "electron": "^27.0.0"
  },
  "build": {
    "appId": "com.Comparix.community",
    "productName": "Comparix Community",
    "directories": {
...
```json
{
  ...
  "build": {
    "appId": "com.Comparix.enterprise",
    "productName": "Comparix Enterprise",
    "directories": {
    ...
    "publish": {
      "provider": "s3",
      "bucket": "Comparix-enterprise-releases",
      "region": "us-east-1"
    }
  }
}
...
특히 **Community Edition을 통한 마케팅 효과**와 **Enterprise Edition의 수익성**을 동시에 확보할 수 있어, Comparix의 상업적 성공 확률을 크게 높일 수 있는 전략입니다.